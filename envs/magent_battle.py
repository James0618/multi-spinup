...
def parallel_env(map_size=default_map_size, max_cycles=max_cycles_default, minimap_mode=minimap_mode_default,
                 view_range=default_view_range, extra_features=False, **reward_args):
    env_reward_args = dict(**default_reward_args)
    env_reward_args.update(reward_args)
    return _parallel_env(map_size, minimap_mode, env_reward_args, max_cycles, extra_features, view_range)


def raw_env(map_size=default_map_size, max_cycles=max_cycles_default, minimap_mode=minimap_mode_default,
...
def get_config(map_size, minimap_mode, step_reward, dead_penalty, attack_penalty, attack_opponent_reward, view_range=6):
    gw = magent.gridworld
    cfg = gw.Config()
    ...
    options = {
        ...
        'view_range': gw.CircleRange(view_range), 'attack_range': gw.CircleRange(1.5),
...
class _parallel_env(magent_parallel_env, EzPickle):
    ...
    def __init__(self, map_size, minimap_mode, reward_args, max_cycles, extra_features, view_range=6):
        ...
        env = magent.GridWorld(get_config(map_size, minimap_mode, **reward_args, view_range=view_range),
                               map_size=map_size)
        self.leftID = 0
        self.rightID = 1
