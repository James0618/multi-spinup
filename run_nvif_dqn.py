...
def run(exp_name='mfq', config_name='mfq'):
    ...
    nvif_dqn(lambda: GatherEnv(args=args), args=args, logger_kwargs=logger_kwargs)
...
if __name__ == '__main__':
    ...
    experiment = 'gather-nvif-dqn-{}-{}/{}'.format(t.tm_mon, t.tm_mday, experiment_id)
    # experiment = 'final results/1/random scenario/48/mfq'
    config_name = 'nvif_dqn'
